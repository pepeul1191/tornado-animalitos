...
gulp.task('layout-css', function() {
      ...
      .pipe(minifyCss())
      .pipe(replace('../../../font-awesome/fonts/', ''))
      .pipe(gulp.dest('media/dist/assets'));
});

gulp.task('layout-js', function() {
    gulp.src(['media/bower_components/jquery/dist/jquery.min.js', 'media/bower_components/bootstrap/dist/js/bootstrap.min.js', 'media/bower_components/underscore/underscore-min.js', 'media/bower_components/swp-plugins/assets/js/mootools-core.min.js', 'media/bower_components/swp-plugins/assets/js/mootools.min.js', 'media/bower_components/swp-plugins/assets/js/mootools-interfaces.min.js'])
