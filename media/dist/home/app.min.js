...
$(document).ready(function(){var o=$("#menu-modulos").html(),r=Handlebars.compile(o)({base_url:"HOLA MUNDO!!!"});$(".navbar-nav").html(r)}),Handlebars.registerHelper("menuModulos",function(){var o="";return MODULOS_JSON.forEach(function(r){o=o+'<li class="dropdown"><a href="'+BASE_URL+r.url+'" class="dropdown-toggle" data-toggle="dropdown">'+r.nombre+"</a></li>"}),o});
