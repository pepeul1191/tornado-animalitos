...
$(document).ready(function(){var e=$("#home-template").html(),r=Handlebars.compile(e);Handlebars.registerPartial("menu_modulos",$("#menu-modulos").html()),Handlebars.registerPartial("yield",$("#yield").html());var l=r({BASE_URL:BASE_URL,STATICS_URL:STATICS_URL,DATA:DATA});$("body").html(l)}),Handlebars.registerHelper("menuModulos",function(){var e="";return MODULOS_JSON.forEach(function(r){e=e+'<li class="dropdown"><a href="'+BASE_URL+r.url+'" class="dropdown-toggle" data-toggle="dropdown">'+r.nombre+"</a></li>"}),e}),Handlebars.registerHelper("getValue",function(e,r){return e[r]});
